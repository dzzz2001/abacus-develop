...
class BigGridInfo
{
    public:
        ...
        // getter functions
        const Vector3 &get_vec1() const { return biggrid_vec1_; };
        const Vector3 &get_vec2() const { return biggrid_vec2_; };
        const Vector3 &get_vec3() const { return biggrid_vec3_; };
        ...
        const std::vector<Vector3>& get_meshgrid_coords() const { return meshgrid_coords_; };
        ...
        ModuleBase::Vector3<int> meshgrid_idx_1Dto3D(int index_1d) const
        {
    ...
    private:
        ...
        Vector3 biggrid_vec1_;
        Vector3 biggrid_vec2_;
        Vector3 biggrid_vec3_;
        ...
        std::vector<Vector3> meshgrid_coords_;
};
