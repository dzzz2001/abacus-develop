    ...
    for (int ia1 = 0; ia1 < na_grid; ia1++) {
        ...
        if (if_symm) // density
        {
            ...
            std::vector<int>::const_iterator find_end
                = std::next(gt.find_R2[iat].begin(), gt.nad[iat]);
            // ia2==ia1
            int cal_num = 0;
            ...
            if (cal_num > 0) {
                ...
                offset = -1;
                for (auto find = find_start.begin(); find < find_start.end();
                     find++) {
                    //--------------------------------------------------------------
                    ...
                    if (*find == index) {
                        offset = find
                                 - find_start.begin(); // start positions of
        ...
        for (int ia2 = start; ia2 < na_grid; ia2++) {
            ...
            std::vector<int> find_start(gt.find_R2[iat].begin(),
                                        gt.find_R2[iat].begin() + gt.nad[iat]);

            for (std::vector<int>::iterator find = find_start.begin();
                 find != find_start.end();
                 ++find) {
                if (*find == index) {
