...
namespace LR_Util
{
    ...
    void diag_lapack(const int& n, double* mat, double* eig)
    {
        ...
        char jobz = 'V', uplo = 'U';
        LapackConnector::syev(LapackConnector::ColMajor, jobz, uplo, n, mat, n, eig);
    }
    ...
    void diag_lapack(const int& n, std::complex<double>* mat, double* eig)
    {
        ...
        char jobz = 'V', uplo = 'U';
        LapackConnector::heev(LapackConnector::ColMajor, jobz, uplo, n, mat, n, eig);
    }
    ...
    void diag_lapack_nh(const int& n, double* mat, std::complex<double>* eig)
    {
        ...
        LapackConnector::geev(LapackConnector::ColMajor, jobvl, jobvr, n, mat, n, eig_real.data(), eig_imag.data(),
    ...
    void diag_lapack_nh(const int& n, std::complex<double>* mat, std::complex<double>* eig)
    {
        ...
        LapackConnector::geev(LapackConnector::ColMajor, jobvl, jobvr, n, mat, n, eig,
            vl.data(), ldvl, vr.data(), ldvr);
    }
